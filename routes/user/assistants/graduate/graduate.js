...
router.get('/assistants/graduate/original', queryFree, queryGeneral, queryPass, queryCourse, queryRule, queryNow, processOther, processCS, processResult, currentOther, currentCS, function(req, res){
