...
router.get('/assistants/graduate/revised', queryPass, queryCourse, queryRule, processOther, processCS, processResult, function(req, res){
...
function queryPass(req, res, next){
	...
	console.log("test asistants!!!!!! in queryPass");
...
function queryCourse(req, res, next){
    if(req.session.profile){
			var studentId = req.query.student_id;
			console.log("test asistants!!!!!! in queryCourse");
	                console.log(studentId);
			if(!studentId){
				console.log("No Student Id");
				return;
...
function queryRule(req, res, next){
    if(req.session.profile){
         var studentId =  req.query.student_id;
				 console.log("test asistants!!!!!! in queryRule");
         console.log(studentId);
         if(!studentId){
                  console.log("No Student Id");
                  return;
...
function processCS(req, res, next){
	...
	if(req.session.profile){
		var studentId = req.query.student_id;
		console.log("test asistants!!!!!! in processCS");
	console.log(studentId);
