...
router.get('/students/graduate/original', StudentId, queryFree, queryGeneral, queryPass, queryCourse, queryRule, queryNow, processOther, processCS, processResult, currentOther, currentCS, function(req, res){
