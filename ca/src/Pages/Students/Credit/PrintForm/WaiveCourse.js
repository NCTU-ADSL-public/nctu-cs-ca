    ...
    return (
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <table className='course-form' cellSpacing='0' cellPadding='0' style={{ width: '100%', margin: '5pt auto', borderCollapse: 'collapse', fontSize: '8pt' }}>
            <tbody>
              ...
              </tr>
              {
                ...
                waiveCourse.map((data, index) => (
                  <tr style={{ height: '32pt' }} key={index}>
                    ...
                    <td style={{ width: '57.2pt' }}>{data.original_course_department}</td>
                    <td style={{ width: '15.2pt' }}>{data.original_course_semester === 1 && data.original_course_credit}</td>
                    <td style={{ width: '15.2pt' }}>{data.original_course_semester === 1 && data.original_course_score}</td>
                    <td style={{ width: '15.2pt' }}>{data.original_course_semester === 2 && data.original_course_credit}</td>
                    <td style={{ width: '15.2pt' }}>{data.original_course_semester === 2 && data.original_course_score}</td>
                    <td colSpan='2' style={{ width: '219.2pt' }}>{data.current_course_code} / {data.current_course_name}</td>
                    <td style={{ width: '9.2pt' }}>{data.current_course_credit}</td>
                    <td style={{ width: '9.2pt' }}></td>
                    <td style={{ width: '15.2pt' }}>{data.current_course_type}</td>
        ...
        <div style={{ marginLeft: '36pt', fontSize: '10pt' }}>4.課程通過抵免，若已加選此課程，請學生務必於1週內<span className='underline'>至課務組辦理逾期退選</span>。</div>
