...
class GradCreditCheck extends React.Component {
  constructor (props) {
    ...
    this.printGradTable = this.printGradTable.bind(this)
    this.clearManual = this.clearManual.bind(this)
    this.ReviseClick = this.ReviseClick.bind(this)
    this.handleToggle = this.handleToggle.bind(this)
    this.handleClose = this.handleClose.bind(this)
    this.handleClickview = this.handleClickview.bind(this)
    this.handleCloseforRevise = this.handleCloseforRevise.bind(this)
    this.handleOpenforRevise = this.handleOpenforRevise.bind(this)
    this.handleAssistantPost = this.handleAssistantPost.bind(this)
          ...
          <div className='tip'>
            ...
            <Popover
              ...
              <div
                style={styles.pop}>
                {this.state.isToggle
                  ? <div><b>-未排序</b><br />物理學分放置規則：於必修項目會算為3學分,多的2學分將優先放至專業選修,若專業選修已滿,則會放至其他選修,物理也會顯示在該項項目中。</div>
                  : <div><b>-已排序</b><br /><br />
