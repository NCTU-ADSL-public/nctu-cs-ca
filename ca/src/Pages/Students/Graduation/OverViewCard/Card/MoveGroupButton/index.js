...
class Index extends React.Component {
  ...
  render () {
    ...
    const shouldBeDisabled = ((englishCheck === '0' || englishCheck === null) && this.props.item.cn.search('進階英文') !== -1) || this.props.item.reason === 'english' || this.item.moveTargets !== undefined
