    ...
    { title: '必修課程',
        ...
        course:
            [ {"cn":"資料庫系統概論","en":"Introduction to Database Systems","code":"DCP1187","score":-1,"complete":"true","english":false,"grade":"0","year":4,"semester":1,"reason":"NotCS"},{ cn: '作業系統概論', en: 'Introduction to Operating Systems',"score":60 ,complete:true, grade:'0'},
                ...
                { cn: '物理(一)',realCredit:3, en: '' ,complete:true,"score":60 },
    ...
    { title: '體育',
        ...
        course:
            [ { cn: '心理學概論', en: '', dimension: '群己', complete: true },
                { cn: '當代世界:環境危機與生態永續', en: '', dimension: '通識', complete: true },
                { cn: '幾何造形', en: '', dimension: '自然', complete: true },
                { cn: '經濟學概論', en: '', dimension: '歷史', complete: false } ] },
    { title: '外文',
        credit: '20',
        require: '60',
        course:
