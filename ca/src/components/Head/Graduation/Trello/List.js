    ...
    return (
        <div>
            ...
            <div style={{ fontSize: 12, color: '#BD3B36' }}>
                ...
                <div style={{ padding: '5px 0px', fontWeight: 'bold'  }}>{props.description === "notCS"?<i>尚未抵免此課程</i>:(props.description === "當期課程" || props.description === "未修此課程" )?<i>{props.description}</i>:<i>分數: {props.description}</i>}</div>
            </div>
        </div>
    )
}
