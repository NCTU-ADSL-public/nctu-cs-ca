                        ...
                        <div className="schedule-bar">
                            ...
                            <div className="overview">
                                ...
                                <div className="overview-course" >
                                    ...
                                    <div className="showcourseoverview" onClick={()=>this.scrollTo('外文')}>外&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;文&nbsp;&nbsp;<font size={5} color='#338d68'>{this.state.totalitems.language}</font>/{this.state.totalitems.language_require}&nbsp;學分<br/><AnimatedProgress value={this.state.totalitems.language/this.state.totalitems.language_require*100}/></div>
                                </div>
                                <div className="overview-course" >
