    ...
    render() {
            return (
                <div  className="little-form"  ref="my">
                    <div id="little-title">
                        <IndividualProgress grad={(this.props.title==="體育"||this.props.title==='服務學習'||this.props.title==='藝文賞析')?(this.props.pass.length - this.state.flag)/this.props.total * 100:this.props.credit/this.props.total * 100}/>
