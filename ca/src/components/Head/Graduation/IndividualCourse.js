                ...
                <div  className="little-form"  ref="my">
                    <div id="little-title">
                        ...
                        <div className="little-title-title">
                            <div id="little-title-number"><font size={6} color='#338d68'>{this.props.credit}</font>/{this.props.total}{(this.props.title==="體育"||this.props.title==='服務學習'||this.props.title==='藝文賞析')?'(門)':'(學分)'}</div>
