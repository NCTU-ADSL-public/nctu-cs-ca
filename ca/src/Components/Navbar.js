  ...
  render() {
    ...
    const navItems = {
      'student': [
        ...
        <NavButton key={1} label='畢業預審' icon='fa fa-graduation-cap' onClick={this.props.subname.match('資工')===null && this.props.subname.match('資電')===null && this.props.subname.match('網多')===null?()=>alert('非資工系學生無此功能'):onClicks[1]} selected={selectedButtonIndex === 1}/>,
        <NavButton key={2} label='課程地圖' icon='fa fa-map' onClick={this.props.subname.match('資工')===null && this.props.subname.match('資電')===null && this.props.subname.match('網多')===null?()=>alert('非資工系學生無此功能'):onClicks[2]} selected={selectedButtonIndex === 2}/>,
