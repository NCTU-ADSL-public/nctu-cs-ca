...
DragAndZoom.propTypes = process.env.NODE_ENV !== "production" ? {
  zoomStep: _propTypes.number,
  initialZoom: _propTypes.number,
  minZoom: _propTypes.number,
  maxZoom: _propTypes.number,
  onZoom: _propTypes.func,
  onMouseDown: _propTypes.func,
  onDragStart: _propTypes.func,
  onDrag: _propTypes.func,
  onDragStop: _propTypes.func,
  bounds: (0, _propTypes.oneOf)([(0, _propTypes.shape)({ left: _propTypes.number, top: _propTypes.number, right: _propTypes.number, bottom: _propTypes.number }), _propTypes.string, 'parent'])
} : {};
exports.default = DragAndZoom;
