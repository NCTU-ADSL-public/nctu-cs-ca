...
var BoardContainer = function (_Component) {
  ...
  (0, _createClass3.default)(BoardContainer, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (onDataChange && nextProps.reducerData && !(0, _isEqual2.default)(reducerData, nextProps.reducerData)) {
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          style = _props2.style,
          otherProps = (0, _objectWithoutProperties3.default)(_props2, ['reducerData', 'style']);
      ...
      return _react2.default.createElement(
        ...
        reducerData.lanes.map(function (lane) {
          ...
          var passthroughProps = (0, _pick2.default)(_this2.props, ['onLaneScroll', 'onCardClick', 'onLaneClick', 'laneSortFunction', 'draggable', 'handleDragStart', 'handleDragEnd', 'customCardLayout', 'customLaneHeader', 'tagStyle', 'children']);
          return _react2.default.createElement(_Lane2.default, (0, _extends3.default)({ key: '' + id, id: id, droppable: droppable === undefined ? true : droppable }, otherProps, passthroughProps));
        })
      );
    }
  }]);
